...
import com.example.poms_quizlet.config.Level3_Config;
...
public class Level3 extends AppCompatActivity implements View.OnClickListener{
    ...
    private Level3_Config question = new Level3_Config();
    ...
    public void onBackPressed() {
        Toast.makeText(Level3.this, "Игра не завершена. Вы возвращены в главное меню", Toast.LENGTH_SHORT).show();
        Intent intentLevel1 = new Intent(Level3.this, LevelSelectionActivity.class);
