...
import com.example.poms_quizlet.config.Level2_Config;

public class Level2 extends AppCompatActivity implements View.OnClickListener{
    Button btn_one, btn_two, btn_three, btn_four;
    TextView tv_question;

    private Level2_Config question = new Level2_Config();
    ...
    public void onBackPressed() {
        Toast.makeText(Level2.this, "Игра не завершена. Вы возвращены в главное меню", Toast.LENGTH_SHORT).show();
        Intent intentLevel1 = new Intent(Level2.this, LevelSelectionActivity.class);
